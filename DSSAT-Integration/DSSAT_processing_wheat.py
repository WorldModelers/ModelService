...
if __name__ == "__main__":
    ...
    urllib.request.urlretrieve("https://world-modelers.s3.amazonaws.com/data/DSSAT/ETH_ALL_Wheat_baseline_and_single_sens.tar.xz", "dssat_baseline_wheat.tar.xz")

    print("Unpacking DSSAT basline files...")
    shutil.unpack_archive("dssat_baseline_wheat.tar.xz", "dssat_baseline_wheat")

    print("Downloading DSSAT sensitivity file...")
    urllib.request.urlretrieve("https://world-modelers.s3.amazonaws.com/data/DSSAT/ETH_Oromia_Wheat_global_sens.tar.xz", "dssat_sensitivity_wheat.tar.xz")

    print("Unpacking DSSAT sensitivity files...")
    shutil.unpack_archive("dssat_sensitivity_wheat.tar.xz", "dssat_sensitivity_wheat")    
